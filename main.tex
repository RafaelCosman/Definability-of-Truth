...
Thus, truth predicates are inconsistent in classical two-valued logic; however, they may yet be salvaged by moving to a more expressive framework and relaxing some constraints on how they work.
...
To put our work in context, we use a two-factor classification scheme for theories: Theories have an \emph{outer} notion of \emph{truth}, \emph{probability}, or \emph{both}.
...
Leitgeb\cite{leitgeb12a} presents a theory that has an outer notion of truth and an inner truth predicate.
...
Our work is novel in having outer notions of truth and probability as well as an inner probability function.
