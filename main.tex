...
we might introduce a predicate $\True$ which acts on encodings of sentences $\q{\varphi}$ and returns their truth value $\Tq{\varphi}$.
...
Let $(a, b)$ be any open interval containing $\Po{\varphi}$.
...
\forall a, b \in \mathbb{Q} : \inOpen{\PP(\varphi)} \iff \PP(\inOpen{\Pq{\varphi}}) = 1 
\end{equation}
...
as a fixed point of a certain revision operation, as in Kripke's Outline of a theory of truth~\cite{kripke75}.
