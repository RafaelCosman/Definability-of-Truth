...
\end{equation}
We use this \emph{reverse reflection principle} in some of the proofs in section~\ref{refl-refl}.
...
It is derived analogously to the reverse outer reflection principle (\ref{reverse-reflection}).
%TODO MATH
}
...
In this section we develop one approach to this, introducing a reflection principle for expectations, ($a < \EE[X] < b \implies \PP[a < E[X] < b] = 1$).
...
%TODO better name needed! (ask Patrick again?)
...
from being both satisfied by $\PP$ and having its inner language analogue assigned probability 1 by $\PP$.
...
The authors would like to thank Steve Rayhawk, Nate Soares, Patrick LaVictoire, Kenny Easwaran, and Diego Caleiro for their help with this paper.
