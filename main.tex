...
Analogously to how the proposed predicate $True$ reflects the notion of truth in the theory, we want a function $P$, in the language, to reflect the outer probability distribution $\PP$.
...
In contrast to this metalanguage reflection principle, which we can think of as an \emph{outer reflection principle}, we might also want $\PP$ to assign probability 1 to $P$'s reflective consistency.
