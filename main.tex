...
%XXX add bit about how to get to next stage XXX KAYA what do you mean by this?

\begin{definition}
Let $T$ be a consistent theory over some language $L$ \footnote{The pair $(T, L)$ must be rich enough to admit Godel numbering}. Let $L'$ be the extension of $L$ by a function symbol $P$. Let $\mathbb{P}$ be a Gaifman coherent probability distribution over $T$.
