...
We wish to construct a probabilistic language which can represent its own sentences' probabilities, which we take as an analogue to the truth values of sentences.
...
We would like this predicate it to satisfy a formal correctness property:
